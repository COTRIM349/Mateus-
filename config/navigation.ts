...
// ── Menu principal (Sprint 14 · Etapa 3) ──────────────────────────────────
// Fluxo mental: cadastra → decide → executa → registra → apura → analisa
//
// Estrutura:
//   Topo (sempre visível): Dashboard
//   Bloco "Cadastros": bases fixas da operação
//   Itens soltos "Clima · Balanço · Decisão · Programação": as decisões
//     diárias — cada uma tem peso próprio, não amassa dentro de bloco
//   Bloco "Lançamentos + OS": registros manuais de campo
//   Itens soltos "Sensores · Reservatórios": infra operacional
//   Bloco "Energia & Custos": prestação de contas financeira
//   Bloco "Relatórios & Inteligência": análise
//   Topo do rodapé "Alertas · Configurações"
...
export const navGroups: NavGroup[] = [
  ...
  {
    // Itens de decisão diária — cada um top-level dentro do bloco (sem sub).
    // O bloco existe só para separar visualmente do "Cadastros" e "Lançamentos".
    label: "Manejo Diário",
    icon: ICON.decision,
    items: [
...
// Lista plana (mantida para consumidores que só querem enumerar tudo)
