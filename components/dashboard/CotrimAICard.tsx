import { recomendacaoIA } from "@/lib/mock-data";

/**
 * Card de destaque com a recomendação simulada da Cotrim AI.
 * Nesta etapa o texto é fixo (sem chamada a IA real).
 */
export function CotrimAICard() {
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-graphite-900 to-graphite-800 p-6 text-white shadow-sm">
      ...
      <div className="relative flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="mt-2 text-sm leading-relaxed text-gray-200">{recomendacaoIA}</p>
        </div>
      </div>
    </div>
  );
