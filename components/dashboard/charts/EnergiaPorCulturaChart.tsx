...
import { energiaPorCultura } from "@/lib/mock-data";
import { formatNumber } from "@/lib/format";

/** Gráfico de área: energia estimada (kWh) por cultura. */
export function EnergiaPorCulturaChart() {
  return (
    <ResponsiveContainer width="100%" height="100%">
      <AreaChart data={energiaPorCultura} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
        <defs>
