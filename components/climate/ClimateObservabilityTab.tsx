            ...
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {snapshot.providers.map((provider) => (
                <div key={provider.provider} className="rounded-2xl border border-gray-100 bg-white p-4 dark:border-white/[0.06] dark:bg-graphite-800">
                  ...
                  <dl className="mt-3 space-y-2 text-xs"><div className="flex justify-between gap-3"><dt className="text-graphite-400">Último payload</dt><dd className="font-medium text-graphite-700 dark:text-gray-300">{fmtDate(provider.lastFetchedAt)}</dd></div><div className="flex justify-between gap-3"><dt className="text-graphite-400">Candidatos</dt><dd className="font-medium text-graphite-700 dark:text-gray-300">{provider.rowsInWindow}</dd></div></dl>
