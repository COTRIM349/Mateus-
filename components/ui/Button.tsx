...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary: "border border-gray-300 bg-white text-graphite-900 hover:bg-gray-50 active:bg-gray-100",
  ghost: "text-gray-600 hover:bg-gray-100 hover:text-graphite-900",
