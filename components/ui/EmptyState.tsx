...
/**
 * Estado de "módulo em construção" usado pelas páginas que ainda
 * não foram totalmente implementadas nesta primeira versão.
 */
export function EmptyState({
  ...
  return (
    <Card className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <h3 className="text-base font-semibold text-graphite-900">{titulo}</h3>
